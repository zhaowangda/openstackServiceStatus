...
print           " <th bgcolor=#E2EAF8>根目录</th>"
print           " <th bgcolor=#E2EAF8>内存</th>"
print           " <th bgcolor=#E2EAF8>进程数</th>"
print   "</tr>"
#--------------------------------------------------------------
result = cur.execute("select DISTINCT hostIP,hostname,allRoles,status,os,weburl,uptime,diskInfo,memInfo,totalProcess  from hostSchema ORDER BY hostIP ")
records = cur.fetchmany(result)
for record in records:
	print "<tr>"
...
#	print '<td><a target="_blank" href="'+ record[5] +'">open</a></td>'
        ...
        print "<td>"+ record[8] +"</td>"
        print "<td>"+ record[9] +"</td>"
	print "</tr>"
